...
const Logo = (
  <svg name='logo' width='100%' height='100%' viewBox='0 0 512 512' fill='none' xmlns='http://www.w3.org/2000/svg'>
    <rect x='2.28882e-05' y='-1.14441e-05' width='512' height='512' rx='256' fill='#070D58' fillOpacity='0.5' />
    <rect x='213' y='106' width='85' height='300' rx='6' fill='#5865F2' />
    <rect x='106' y='298' width='85' height='300' rx='6' transform='rotate(-90 106 298)' fill='#5865F2' />
    <path
